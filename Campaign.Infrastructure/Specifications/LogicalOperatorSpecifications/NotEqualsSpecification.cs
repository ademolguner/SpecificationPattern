...
public class NotEqualsSpecification<T, TProperty>(Expression<Func<T, TProperty>> propertyExpression, TProperty value)
    : ISpecification<T>
{
    ...
    public Expression<Func<T, bool>> ConvertToExpression()
    {
        ...
        var body = Expression.NotEqual(propertyExpression.Body, Expression.Constant(value, typeof(TProperty)));
